...
namespace WebApplicationAnnuaire.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomUtilisateur,MotDePasse,EstAdmin")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Id,NomUtilisateur,MotDePasse,EstAdmin")] Utilisateur utilisateur)
        {
